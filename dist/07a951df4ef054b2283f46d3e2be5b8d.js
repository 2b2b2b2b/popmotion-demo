...
var _vueCommon = require('vue/dist/vue.common.js');

var _vueCommon2 = _interopRequireDefault(_vueCommon);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

let app = _vueCommon2.default.component('app', {
    data: () => ({ duration: 1500 }),
    template: `
    ...
    `,
    mounted() {
        this.bigStyler = (0, _popmotion.styler)(this.$refs.big);
        this.smallStyler = (0, _popmotion.styler)(this.$refs.small);
        this.handleJump();
    },
    methods: {
        jump() {
            const move = (0, _popmotion.keyframes)({
                values: [{
                    scaleX: 1.4,
                    scaleY: 0.6,
                    y: 0
                ...
                easings: [_popmotion.easing.circIn, _popmotion.easing.circOut, _popmotion.easing.circIn, _popmotion.easing.circOut],
                // ease: easing.circInOut,
                loop: Infinity
            }),
                  rotate = (0, _popmotion.keyframes)({
                values: [{
                    rot: 0
                }, {
                    rot: 0
                ...
                duration: this.duration,
                times: [0, 0.15, 0.85, 1],
                easings: [_popmotion.easing.linear, _popmotion.easing.circInOut, _popmotion.easing.linear],
                loop: Infinity
            });
            return (0, _popmotion.parallel)(move, rotate);
        },
        jumpsmall() {
            const move = (0, _popmotion.keyframes)({
                values: [{
        ...
        multijump() {
            return (0, _popmotion.parallel)(this.jump(), this.jumpsmall());
        },
        handleJump() {
            this.multijump().start({
                update: v => {
                    const origin = v[0][0].scaleX === 1 ? 'center center' : 'center bottom';
...
new _vueCommon2.default({ el: '#app', data: {}, components: { app } });
},{"popmotion":25,"vue/dist/vue.common.js":203}],221:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/07a951df4ef054b2283f46d3e2be5b8d.map