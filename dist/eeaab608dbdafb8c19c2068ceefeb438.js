...
const topStyler = (0, _popmotion.styler)(topLine);
const bottomStyler = (0, _popmotion.styler)(bottomLine);
const middleStyler = (0, _popmotion.styler)(middle);
const svgStyler = (0, _popmotion.svg)(path);
console.log(svgStyler);
const topMove = (0, _popmotion.keyframes)({
    values: [{
        left: 0,
        top: 0,
        rotate: 0
...
const ringMove = (0, _popmotion.timeline)([{ track: 'middle', from: { left: 0, width: 36 }, to: { left: -6, width: 42 }, duration: 200, ease: _popmotion.easing.linear }, { track: 'middle', to: { left: 50, width: 0 }, duration: 200, ease: _popmotion.easing.linear }, { track: 'middle', to: { left: 40, width: 0 }, duration: 200, ease: _popmotion.easing.easeOut }, '-250', { track: 'circle', from: 0, to: 100, duration: 300, ease: _popmotion.easing.easeIn }]).start(v => {
    middleStyler.set({
        left: v.middle.left,
...
},{"popmotion":25}],254:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/eeaab608dbdafb8c19c2068ceefeb438.map